...
var local = (function () {
     ...
     * Public API
     ************/
    local.readPackageJson = function (cb) {
        jsonfile.readFile(resolve(local.PACKAGE_JSON), cb);
    };

    local.writePackageJson = function (json, cb) {
        jsonfile.writeFile(resolve(local.PACKAGE_JSON), json, cb);
    };
